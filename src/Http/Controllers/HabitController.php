...
class HabitController extends \Core\Controller
{
    ...
    public function store()
    {
        ...
        $formValidationModel = new CreateHabit(habit: $habitsModel);
        ...
        // Habit form specific validation
        $isValid = $formValidationModel->validateCreateFrom($category, $title, $description);

        // on validation error redirect back to page
        if (!$isValid) {
            $errors = $formValidationModel->errors();
    ...
    public function put($habitId)
    {
        ...
        $formValidationModel = new EditHabit(habit: $habitsModel);
        ...
        // habit form specific validation
        $isValid = $formValidationModel->validateEditFrom($category, $title, $description);
